...
def test_space_initialises_with_required_data():
    space = Space(1, 2, 'title1', 'description1', 100.5, 'address1')
...
def test_spaces_are_equal():
    space1 = Space(1, 2, 'title1', 'description1', 100.5, 'address1')
    space2 = Space(1, 2, 'title1', 'description1', 100.5, 'address1')
...
def test_space_formats_nicely():
    ...
    assert str(space) == "Space(1, 2, title1, description1, 100.5, address1)"