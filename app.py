...
def register():
    ...
    if form.validate_on_submit():
        ...
        new_user = Dummy(None, username=form.username.data, first_name=form.first_name.data, last_name=form.last_name.data, password=hashed_password_string, email=form.email.data, phone_number=form.phone_number.data)
